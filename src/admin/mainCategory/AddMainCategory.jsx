...
import { createMainCategorysRequest } from "../../redux/slice/maincategory/mainCategorySlice";
...
const AddMainCategory = () => {
    ...
    const onSubmit = (data) => {
        ...
        let item = mainCategorys.find(x => x.name.toLocaleLowerCase() === data.name.toLocaleLowerCase())
        if (item) {
            setError("name", {
                type: "manual",
                message: "Maincategory Name is Already Exist"
            });
        } else {
            dispatch(createMainCategorysRequest(data))
